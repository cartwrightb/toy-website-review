...
@description('The name of the storage account to deploy. This name must be globally uniqye')
param storageAccountName string

@description('The name of the qeue to deploy for processing orders')
